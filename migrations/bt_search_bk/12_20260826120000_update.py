...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ADD COLUMN IF NOT EXISTS "group_name" VARCHAR(100) NOT NULL DEFAULT 'total';
        DROP INDEX IF EXISTS "uid_polygon_met_polygon_59bbb7";
        CREATE UNIQUE INDEX IF NOT EXISTS "uid_polygon_met_polygon_group"
        ON "polygon_metric" ("polygon_id", "metric_id", "group_name");
    """
...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "polygon_metric" DROP COLUMN IF EXISTS "group_name";
